...
<html>
    ...
    <body>
        @section('top-navbar')
            <li class="nav-item">
                <a class="nav-link">Set Batas Waktu Pengisian Evaluasi Diri</a>
            </li>
        @endsection
        ...
        @section('isi')
            ...
            <form action="{{ route('ed_set_waktu_action') }}" method="POST">
                @csrf
                <div class="col align-self-center shadow p-3 bg-body-tertiary rounded">
                    ...
                    <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                        <a class="btn btn-danger" style="margin-right: 10px" type="button" value="Batal" href="{{ URL('evaluasi') }}">Batal</a>
