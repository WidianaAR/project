    ...
    @section('isi')
        ...
        <div class="collapse mt-2" id="collapseFilter">
            <div class="card card-body py-2">
                <form action="{{ route('ks_home') }}" method="GET">
                    @csrf
                        ...
                        <tr>
                            ...
                            <td>
                                <a type="button" class="btn btn-outline-secondary btn-sm"
                                    href="{{ route('ks_table', $file->id) }}"><i class="fa fa-sm fa-eye"></i> Lihat</a>
                                @can('kajur')
                                    @if ($deadline[0] && $file->tahun == date('Y'))
                                        <a type="button" class="btn btn-outline-success btn-sm"
                                            href="{{ route('ks_change', $file->id) }}"><i class="fa fa-sm fa-edit"></i>
                                            Ubah</a>
